 ...
 * @author 14649826
 */
public class TelaVisualizacaoConsultas_EmployeeF extends javax.swing.JFrame {

    private ConnectionSetup conexao;
    private DoctorAppointmentDAO daDAO;
    private AvailabilityDAO availabilityDAO;

    /**
     * Creates new form alala
     */
    public TelaVisualizacaoConsultas_EmployeeF() throws SQLException {
        initComponents();
    ...
    layout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addComponent(lblTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE))
            .addGap(23, 23, 23))
    );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizacaoConsultas_EmployeeF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TelaVisualizacaoConsultas_EmployeeF().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVisualizacaoConsultas_EmployeeF.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
