...
public class TelaDisponibilidadesUNUSEDPanel extends javax.swing.JPanel {
    ...
    public TelaDisponibilidadesUNUSEDPanel(int idHealthProfessionals, int idSpecialization) {
