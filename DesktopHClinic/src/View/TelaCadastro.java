...
public class TelaCadastro extends javax.swing.JFrame {
     ...
     * @return se o login é exclusivo (true) ou se já existe outro no banco
     * (false)
     * @throws SQLException excessão gerada ao ocorrer um erro no acesso ao
     * Banco de Dados.
     *
     * private boolean exclusivoLoginSenha(String login, String senha) throws
     * SQLException{ if(employeeDAO.existLogin(login, senha)) return false;
     * return true; }
     */
