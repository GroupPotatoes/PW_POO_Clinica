 ...
 * @author Maiara
 */
public class TelaVisualizacaoConsultas_HealthProfessionalsF extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaVisualizacaoConsultas
     */
    public TelaVisualizacaoConsultas_HealthProfessionalsF(int idDoctor) throws Exception{
...
btnVisualizar.addActionListener(new java.awt.event.ActionListener() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizacaoConsultas_HealthProfessionalsF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TelaVisualizacaoConsultas_HealthProfessionalsF(1095).setVisible(true);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
